            ...
            <div id="filtre-categorie" class="select-filter flexcolumn">   
                <div class="select-wrapper">
                    <select class="option-filter" name="categorie_id" id="categorie_id">
                        ...
                        <option id="categorie_16" value="16">Concert</option>
                        <option id="categorie_12" value="12">Mariage</option>
                        <option id="categorie_15" value="15">Réception</option>
                        <option id="categorie_17" value="17">Télévision</option>
                    </select>
                    <p class="placeholder">catégories</p>
                </div>
            </div>
            <div id="filtre-format" class="select-filter flexcolumn">      
                <div class="select-wrapper">
                    <select class="option-filter" name="format_id" id="format_id"> 
                        ...
                        <option id="format_14" value="14">Paysage</option>
                        <option id="format_13" value="13">Portrait</option>
                    </select>
                    <p class="placeholder">formats</p>
                </div>
            </div>
        </div>
        <div class="filterright swiper-slide flexrow">
            <div id="filtre-date" class="select-filter flexcolumn">       
                <div class="select-wrapper">
                    ...
                    <p class="placeholder">trier par</p>
                </div>
            </div>
        </div>
    </form>
