...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.getElementById("total_posts") !== null) {
    ...
    console.log("Contenu de total_posts après extraction :", total_posts);
  }
  ...
  function recupIdData(arg) {
    // On parcourt le tableau à la recherche de l'identifiant de la photo
  ...
  (function ($) {
    $(document).ready(function () {
      ...
      $(".lightbox__prev").click(function (e) {
        ...
        $.changePhoto();
        console.log("Chargement de la photo avec ID : " + idPhoto);
      });
      ...
      $.changePhoto = function () {
        ...
        const ajaxurl = "http://nathaliemotaphoto.local/wp-admin/admin-ajax.php";
