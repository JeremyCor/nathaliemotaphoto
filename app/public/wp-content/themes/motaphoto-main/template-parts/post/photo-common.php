<?php 
// Initialisation de variables pour les filtres d'affichage des photos
$order = "";          
$orderby = "date";
...
// Création du filtre pour afficher les photos 
$custom_args = array(
...
<!-- Variables qui vont pouvoir être récupérées par JavaScript -->
<form>
